...
from utils import get_frequency, get_locations, get_pregnancy_status
################################################################################
#
...
def get_features(data, recordings):
    ...
    recording_features = np.zeros((num_recording_locations, 79), dtype=float)
        ...
        for i in range(num_locations):
            for j in range(num_recording_locations):
                if compare_strings(locations[i], recording_locations[j]) and np.size(recordings[i])>0:
                    ...
                    recording_features[j, 1:] = get_mfcc_features(recordings[i], frequency)
